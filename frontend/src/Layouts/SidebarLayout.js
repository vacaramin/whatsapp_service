...
const SidebarLayout = ({ theme }) => {
  ...
  const items = [
    ...
    getItem("Apps", "Apps", null,
      [
        getItem(<Link to="/app-email">Email</Link>, "app-email", <Mail size={16} />),
        getItem(<Link to="/app-chat">Chat</Link>, "app-chat", <MessagesSquare size={16} />),
        getItem(<Link to="/app-kanban">Kanban Board</Link>, "app-kanban", <ArrowRightLeft size={16} />),
        getItem(<Link to="/app-contact">Contact</Link>, "app-contact", <UserSquare size={16} />),
        getItem(<Link to="/app-apikey">ApiKey</Link>, "app-apikey", <KeyRound size={16} />),
        getItem(<Link to="/app-leaderboard">LeaderBoard</Link>, "app-leaderboard", <Gem size={16} />),
        getItem(<Link to="/app-todo">To-Do</Link>, "app-todo", <LayoutList size={16} />),
      ],
      "group"
    ),
    getItem("Authentication", "AuthenticationGroup", null,
      [
        getItem("Authentication", "Authentication", <UserCircle2 size={16} />, [
          ...
          getItem(<Link to="/auth-pass-reset">Password Reset</Link>, "auth-pass-reset"),
          getItem(<Link to="/auth-pass-create">Password Create</Link>, "auth-pass-create"),
          getItem(<Link to="/auth-lockscreen">Lock Screen</Link>, "auth-lockscreen"),
          getItem(<Link to="/auth-two-step">Two Step Verification</Link>, "auth-two-step"),
          getItem(<Link to="/auth-success-msg">Success Message</Link>, "auth-success-msg"),
        ]),
        getItem("Pages", "Pages", <Combine size={16} />, [
          getItem(<Link to="/pages-profile">User Profile</Link>, "pages-profile"),
          ...
          getItem(<Link to="/pages-maintenance">Maintenance</Link>, "pages-maintenance"),
        ]),
        getItem("Error Pages", "errorPages", <AlertCircle size={16} />, [
          ...
          getItem(<Link to="/error-offline">OfflinePage</Link>, "error-offline"),
        ]),
        getItem(<Link to="/widget">Widgets</Link>, "widget", <Archive size={16} />),
      ],
      "group"
    ),
    getItem("Components", "ComponentsGroup", null,
      [
        ...
        getItem("Data Entry", "DataEntry", <Gavel size={16} />, [
          getItem(<Link to="/ui-autocomplete">AutoComplete</Link>, "ui-autocomplete"),
          getItem(<Link to="/ui-cascader">Cascader</Link>, "ui-cascader"),
          getItem(<Link to="/ui-checkbox">Checkbox</Link>, "ui-checkbox"),
          getItem(<Link to="/ui-colorpicker">ColorPicker</Link>, "ui-colorpicke"),
          ...
          getItem(<Link to="/ui-input-number">InputNumber</Link>, "ui-input-number"),
          ...
          getItem(<Link to="/ui-tree-select">TreeSelect</Link>, "ui-tree-select"),
        ]),
        getItem("Data Display", "DataDisplay", <Crown size={16} />, [
          ...
          getItem(<Link to="/ui-descriptions">Descriptions</Link>, "ui-descriptions"),
          getItem(<Link to="/ui-empty-images">Empty & Images</Link>, "ui-empty-images"),
        ...
        getItem("Feedback", "Feedback", <Rat size={16} />, [
          ...
          getItem(<Link to="/ui-notification">Notification</Link>, "ui-notification"),
        ...
        getItem("Charts", "Charts", <CandlestickChart size={16} />, [
          getItem("Line Charts", "Line Charts", null, [
            ...
            getItem(<Link to="/charts-multi-line">Multi Line </Link>, "charts-multi-line"),
            getItem(<Link to="/charts-step-line">Step Line</Link>, "charts-step-line"),
          ]),
          getItem("Area Charts", "Area Charts", null, [
            getItem(<Link to="/ui-Basic-Area">Basic Area</Link>, "ui-Basic-Area"),
            getItem(<Link to="/ui-stacked-area">Stacked Area</Link>, "ui-stacked-area"),
            getItem(<Link to="/ui-percentage-area">Percentage Area</Link>, "ui-percentage-area"),
          ]),
          getItem("Column Charts", "Column Charts", null, [
            getItem(<Link to="/ui-Basic-histogram">Basic Histogram</Link>, "ui-Basic-histogram"),
            getItem(<Link to="/ui-Grouped-histogram">Grouped Histogram</Link>, "ui-Grouped-histogram"),
            getItem(<Link to="/ui-Percentage-histogram">Percentage Histogram</Link>, "ui-Percentage-histogram"),
          ]),
          getItem("Bar Charts", "Bar Charts", null, [
            getItem(<Link to="/ui-Basic-bar-chart">Basic Bar</Link>, "ui-Basic-bar-char"),
            getItem(<Link to="/ui-stacked-bar">Stacked Bar</Link>, "ui-stacked-bar"),
            getItem(<Link to="/ui-grouped-bar">Grouped Bar</Link>, "ui-grouped-bar"),
          ]),
          getItem("Pie Charts", "Pie Charts", null, [
            getItem(<Link to="/ui-pie-chart">Pie Chart</Link>, "ui-pie-chart"),
            getItem(<Link to="/ui-Ring-diagram">Ring Diagram</Link>, "ui-Ring-diagram"),
          ]),
          getItem("Progress Chart", "Progress Charts", null, [
            getItem(<Link to="/ui-Dash-board">Dash Board</Link>, "ui-Dash-board"),
            getItem(<Link to="/ui-water-wave-map">Water Wave Map</Link>, "ui-water-wave-map"),
            getItem(<Link to="/ui-Basic-Bullet-Chart">Bullet Chart</Link>, "ui-Basic-Bullet-Chart"),

          ]),
          getItem("Scatter Bubble Chart", "Scatter Bubble Chart", null, [
            getItem(<Link to="/ui-Scatterplot">Scatterplot</Link>, "ui-Scatterplot"),
            getItem(<Link to="/ui-bubble-chart">Bubble Chart</Link>, "ui-bubble-chart"),
          ]),
        ]),

        getItem('Plugins', 'Plugins', <Rat size={16} />, [
          getItem(<Link to="/plugins-text-editor">Text Editor</Link>, 'plugins-text-editor'),
          getItem(<Link to="/plugins-forms">Forms</Link>, 'plugins-forms'),
          getItem(<Link to="/plugins-clipboard">Clipboard</Link>, 'plugins-clipboard'),
          getItem(<Link to="/plugins-video">Video</Link>, 'plugins-video'),
          getItem(<Link to="/plugins-text-loop">Text Loop</Link>, 'plugins-text-loop'),
          getItem(<Link to="/plugins-animation">Animation</Link>, 'plugins-animation'),
        ]),
      ],
      "group"
    ),
